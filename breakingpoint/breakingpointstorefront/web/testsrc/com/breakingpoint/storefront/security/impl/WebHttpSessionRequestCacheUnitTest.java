...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/breakingpointstorefront/electronics/en",
						"https://electronics.local:9002/breakingpointstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/breakingpointstorefront/electronics/en",
						"https://electronics.local:9002/breakingpointstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/breakingpointstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/breakingpointstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/breakingpointstorefront/electronics/en",
						"https://electronics.local:9002/breakingpointstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/breakingpointstorefront",
						"https://electronics.local:9002/breakingpointstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/breakingpointstorefront",
						"https://electronics.local:9002/breakingpointstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/breakingpointstorefront/electronics/en",
						"https://electronics.local:9002/breakingpointstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
