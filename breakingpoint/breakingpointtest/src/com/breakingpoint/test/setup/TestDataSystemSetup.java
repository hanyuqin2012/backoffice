 ...
 */
package com.breakingpoint.test.setup;
...
import com.breakingpoint.test.constants.BreakingpointTestConstants;
import com.breakingpoint.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = BreakingpointTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/breakingpointtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/breakingpointtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/breakingpointtest/import/cstickets.impex");
			...
			importImpexFile(context, "/breakingpointtest/import/csquotes.impex");
		}
	}
}
