 ...
 */
package com.breakingpoint.cockpits.setup;
...
import com.breakingpoint.cockpits.constants.BreakingpointCockpitsConstants;
 ...
 */
@SystemSetup(extension = BreakingpointCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(BreakingpointCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(BreakingpointCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						BreakingpointCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/breakingpointcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
