 ...
 */
package com.breakingpoint.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(BreakingpointFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(BreakingpointFulfilmentProcessConstants.PARENT_PROCESS);
